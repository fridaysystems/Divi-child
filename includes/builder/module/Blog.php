<?php
/**
 * @link https://intercom.help/elegantthemes/en/articles/4532734-moving-blog-module-in-child-theme
 */
//require_once 'helpers/Overlay.php';
//class ET_Builder_Module_Blog extends ET_Builder_Module_Type_PostBased {

get_template_part( 'helpers/Overlay.php' );
class Divi_Child_ET_Builder_Module_Blog extends ET_Builder_Module_Type_PostBased {
	/**
	...
	function init() {
		...
		$this->vb_support       = 'off'; // Divi-child change.
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( have_posts() ) {
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post clearfix divi-child' . $no_thumb_class . $overlay_class . $item_class ); ?>>
				...
				printf(
					'<span class="invp-condition-year">%s %s</span>',
					esc_html( $condition ),
